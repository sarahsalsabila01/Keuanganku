...
<head>
    ...
    <!-- color CSS -->
    <link href="<?php echo base_url ?>assets/pixeladmin-lite/html/css/colors/blue.css" id="theme" rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        >
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="fa fa-bars"></i></a>
                <div class="top-left-part"><a class="logo" href="<?= base_url ?>"><b><img src="<?php echo base_url ?>assets/pixeladmin-lite/plugins/images/pixeladmin-logo.png" alt="home" /></b><span class="hidden-xs"><img src="<?php echo base_url ?>assets/pixeladmin-lite/plugins/images/pixeladmin-text.png" alt="home" /></span></a></div>
